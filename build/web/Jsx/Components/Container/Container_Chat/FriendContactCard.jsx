...
export default function FriendContactCard({ data, setShowFriends }) {
    const { dataContainerChat, setDataContainerChat } = React.useContext(ContainerContext);

    function showThisConversation(data) {
        var SSData = JSON.parse(sessionStorage.getItem(data.ShutId));
        if(SSData==null){
            setDataContainerChat({ ...dataContainerChat, CurrentChat: data.ShutId, DataCurrentUser: data,CurrentConversation:null});
        }else{
            setDataContainerChat({ ...dataContainerChat, CurrentChat: data.ShutId, DataCurrentUser: data,CurrentConversation:SSData.Messages});
        }
        ...
        <>
            <div className={'FriendContactCard'}  >
                ...
                <div className="actionBtns">
                    ...
                    <div className="btn_custom" onClick={() => (showThisConversation(data))}>
