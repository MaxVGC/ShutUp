...
export default function NotificationComponent() {
  ...
  }, "Solicitudes")), /*#__PURE__*/React.createElement("div", {
    className: "row NotificationComponentMain-FriendRequest",
    style: {
      padding: 0,
      margin: 0
    }
  }, FriendRequests.request.map((elements, key) => /*#__PURE__*/React.createElement(RequestCard, {
    key: key,
    data: elements
  })))));
}